...
def Weno5 (WenoType='JS'):
  ...
  elif WenoType == 'Z' :  return Weno5_Z
...
#===============================================================================
# CLASS: Weno5_Z
#  See: "An improved weighted essentially non-oscillatory scheme for hyperbolic 
#        conservation laws", J. Comput. Phys., 2008.  
#        {http://dx.doi.org.proxy2.cl.msu.edu/10.1016/j.jcp.2007.11.038}.
#===============================================================================
...
class Weno5_Z (WenoReconstruction):
  ...
  improvement on Jing-Shu's algorithm.  
  Using two 5-point stencils centered about x[i], function u(x) is 
